...
namespace Test02 {
    internal class Program {
        ...
        private static void Exercise04(int[] numbers) {
            numbers.Where(n => 10 <= n && n <= 50).ToList()
        ...
        private static void Exercise07(List<string> cities) {
            cities.Order().ToList().ForEach(Console.WriteLine);
        ...
        private static void Exercise08(List<string> cities) {
            cities.ForEach(s => Console.WriteLine($"{s} : {s.Length}文字"));
        ...
        private static void Exercise09(List<string> cities) {
            cities.OrderBy(s => s.Length).ToList()
                .ForEach(s => Console.WriteLine($"{s} : {s.Length}文字"));
        ...
        private static void Exercise10(List<string> cities) {
            cities.Where(s => s.Length == 6).ToList().ForEach(Console.WriteLine);
