...
namespace UnitConverter {
    ...
    public static class MerterConverter {
        ...
        private const double oneYardToInch = 36;
        ...
        public static double InchToYard(int _inch) {
            double rtn = _inch / oneYardToInch;
            return rtn;
        }
        public static double YardToInch(int yard) {
            double rtn = yard * oneYardToInch;
            return rtn;
        }
