...
namespace Section03 {
    internal class Program {
        static void Main(string[] args) {
            var match = Regex.Match(text, @"\p{IsKatakana}+");
            if (match.Success) {
        ...
        static string text = "私は、その男の写真を三葉、見たことがある。\r\n" +
            ...
            "「なんて、いやな子供だ」\r\n" +
            "と頗すこぶる不快そうに呟つぶやき、毛虫でも払いのける時のような手つきで、" +
            "その写真をほうり投げるかも知れない。\r\n" +
            "まったく、その子供の笑顔は、よく見れば見るほど、何とも知れず、" +
            "イヤな薄気味悪いものが感ぜられて来る。どだい、それは、笑顔でない。" +
            "この子は、少しも笑ってはいないのだ。" +
            ...
            "学生服を着て、胸のポケットから白いハンケチを覗のぞかせ、" +
            "籐椅子とういすに腰かけて足を組み、そうして、やはり、笑っている。こんどの笑顔は、" +
            "皺くちゃの猿の笑いでなく、かなり巧みな微笑になってはいるが、しかし、人間の笑いと、" +
            "どこやら違う。血の重さ、とでも言おうか、生命いのちの渋さ、とでも言おうか、" +
            "そのような充実感は少しも無く、それこそ、鳥のようではなく、羽毛のように軽く、" +
            "ただ白紙一枚、そうして、笑っている。つまり、一から十まで造り物の感じなのである。" +
            "キザと言っても足りない。軽薄と言っても足りない。ニヤケと言っても足りない。" +
            "おしゃれと言っても、もちろん足りない。しかも、よく見ていると、" +
            "やはりこの美貌の学生にも、どこか怪談じみた気味悪いものが感ぜられて来るのである。" +
            ...
            "謂わば、坐って火鉢に両手をかざしながら、自然に死んでいるような、まことにいまわしい、" +
            "不吉なにおいのする写真であった。奇怪なのは、それだけでない。その写真には、" +
            "わりに顔が大きく写っていたので、私は、つくづくその顔の構造を調べる事が出来たのであるが、" +
            "額は平凡、額の皺も平凡、眉も平凡、眼も平凡、鼻も口も顎あごも、ああ、この顔には表情が無いばかりか、" +
            "印象さえ無い。特徴が無いのだ。たとえば、私がこの写真を見て、眼をつぶる。既に私はこの顔を忘れている。" +
            "部屋の壁や、小さい火鉢は思い出す事が出来るけれども、その部屋の主人公の顔の印象は、すっと霧消して、" +
            "どうしても、何としても思い出せない。画にならない顔である。漫画にも何もならない顔である。眼をひらく。" +
            "あ、こんな顔だったのか、思い出した、というようなよろこびさえ無い。極端な言い方をすれば、" +
            "眼をひらいてその写真を再び見ても、思い出せない。そうして、ただもう不愉快、イライラして、" +
            "つい眼をそむけたくなる。\r\n" +
            "所謂いわゆる「死相」というものにだって、" +
            "もっと何か表情なり印象なりがあるものだろうに、人間のからだに駄馬の首でもくっつけたなら、" +
            "こんな感じのものになるであろうか、とにかく、どこという事なく、見る者をして、ぞっとさせ、" +
